...
# mixed up on each display. The submarine is still trying to display numbers
# by producing output on signal wires a through g, but those wires are
...
#' _gecf egdcabf bgf_ bfgea
#' fgeab ca afcebg bdacfeg cfaedg gcfdb baec bfadeg bafgc acf |
#' _gebdcfa ecba ca fadegcb_
#' dbcfg fgd bdegcaf fgec aegbdf ecdfab fbedc dacgb gdcebf gf |
#' _cefg_ dcbef _fcge gbcadfe_
#' bdfegc cbegaf gecbf dfcage bdacg ed bedf ced adcbefg gebcd |
#' _ed_ bcgafe cdgba cbgef
#' egadfb cdbfeg cegd fecab cgb gbdefca cg fgcdab egfdb bfceg |
#' _gbdfcae bgc cg cgb_
